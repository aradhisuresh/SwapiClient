...
{
    public class PublicKeyValidationMiddlewareTests
    {
        public PublicKeyValidationMiddlewareTests()
        {
        }
       ...
       .StartAsync();
        ...
        public async Task InvalidGuidHeader()
        {
            ...
            var context = await server.SendAsync(c =>
            {
                ...
                c.Request.Path = "/swapi/public/characters";
                c.Request.QueryString = new QueryString("?page=1");
                c.Request.Headers.Add(SwapiClient.Domain.Constant.GenericConstants.PublicApiKeyName, "abcd");
            });
        ...
        public async Task ValidGuidHeader()
        {
            ...
            var context = await server.SendAsync(c =>
            {
                ...
                c.Request.Path = "/swapi/public/characters";
                c.Request.QueryString = new QueryString("?page=1");
                c.Request.Headers.Add(SwapiClient.Domain.Constant.GenericConstants.PublicApiKeyName, "47f1cb5d-eb9b-4fd3-96f7-65e651cd0093");
            });
